...
Now you have the `ogtha` Python package installed in your `ogtha-dev` conda environment. Now you will be able to run the modules of the OG_THA model from scripts and from Jupyter notebooks.
