...
from ogtha.calibrate import Calibration
from ogtha.utils import is_connected
...
def main():
    ...
    save_dir = os.path.join(CUR_DIR, "OG_THA-Example")
    ...
    with importlib.resources.open_text(
        "ogtha", "ogtha_default_parameters.json"
    ) as file:
    ...
    op.plot_all(
        base_dir, reform_dir, os.path.join(save_dir, "OG_THA_example_plots")
    )

    print("Percentage changes in aggregates:", ans)
    # save percentage change output to csv file
    ans.to_csv(os.path.join(save_dir, "OG_THA_example_output.csv"))
